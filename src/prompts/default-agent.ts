...
- *Agent dir* — \`~/.agents/\` (global instructions, skills, and extensions). Pi auth and model files live at \`~/.pi/agent/\`; Flitterbot memory lives at \`~/.flitterbot/data/MEMORY.md\`. Agent resources can be reloaded via \`/reload\`.
