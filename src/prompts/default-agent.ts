...
- *Workstream creation* — use the \`create_workstream\` tool when engineering work is needed. Pick a short descriptive name (2-5 words, lowercase, dash-separated). You can pass an initial message to enqueue onto the new workstream.
...
3. Report back to the user what was launched
